...
<div class="report-index">
    ...
    <div align="center">
            ...
            <label class="control-label"><h3 class="title">Laporan Pendapatan per Periode <u><span id="id-postdate"></span></u></h3></label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <label class="control-label title"><strong> Total Bersih</strong</label>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
    ...
    function reportFo(posting)
    {
        ...
        tt = $('#tbl_laporan_pengeluaran').DataTable({
            ...
            "ajax": {
                "type": 'GET',
                "dataType": "JSON",
                "url": "<?=\Yii::$app->getUrlManager()->createUrl("myadmin/report/getdatareportfopengeluaranspec");?>?posting="+posting,
            },
            "columns": [
                 {"data": "no"},
                 {"data": "item"},
