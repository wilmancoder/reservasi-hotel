        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <?= Html::a('<i class="fa fa-plus"></i> Tambah Booking', 'javascript:addbooking()', ['class' => 'btn btn-default pull-right tombol']) ?>
                </div>
...
function addbooking() {
     var url = "<?php echo \Yii::$app->getUrlManager()->createUrl(['myadmin/booking/create']);?>";
