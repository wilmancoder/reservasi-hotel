    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body">
                    <table id="tbl_detail_booking" class="table table-striped table-bordered" style="width:100%">
                     <thead>
                     <tr>
                         <th>Checkin</th>
                         <th>Checkout</th>
...
// }
    ...
    $(document).ready(function () {
        ...
        t = $('#tbl_detail_booking').DataTable();
         items_preview();
    ...
    function items_preview()
    {
        ...
        t = $('#tbl_detail_booking').DataTable({
            ...
            "info": false,
            "searching": false,
            "ajax": '<?=\Yii::$app->getUrlManager()->createUrl("myadmin/booking/generatedetailbooking");?>?idtranstamu='+idtranstamu,
            "columns": [
